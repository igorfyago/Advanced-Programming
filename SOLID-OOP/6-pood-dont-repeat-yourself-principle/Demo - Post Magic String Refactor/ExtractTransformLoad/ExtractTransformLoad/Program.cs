...
namespace ExtractTransformLoad
{
    internal class Program
    {
        ...
        private static string _decimalFormatString = "{0}:{1:#.##}";
        ...
        private static void Transform()
        {
            ...
            if (_freightByShipperList.Count > 0)
            {
                ...
                Console.WriteLine(_decimalFormatString, _freightByShipperList[0].ShipperName, _freightByShipperList[0].Freight);
            }

            if (_freightByShipperList.Count > 1)
            {
                int index = 1;
                _freightByShipperList[index].Freight =
                    (decimal)
                    _invoiceTable.Compute("sum(freight)", "shippername='" + _freightByShipperList[1].ShipperName + "'");
                Console.WriteLine(_decimalFormatString, _freightByShipperList[index].ShipperName, _freightByShipperList[index].Freight);
            }
            ...
            if (_freightByShipperList.Count > 2)
            {
                ...
                Console.WriteLine(_decimalFormatString, _freightByShipperList[2].ShipperName, _freightByShipperList[2].Freight);
            }
